...
import { Search, Layers, Code2, Rocket, Sparkles } from 'lucide-react'
      ...
      <div className="grid">
        ...
        <section className="card fun">
          <div className="stage" ref={funRef}>
            <div className="ava c1"><Search size={38} strokeWidth={2.2} /></div>
            <div className="ava c2"><Layers size={38} strokeWidth={2.2} /></div>
            <div className="ava c3"><Code2 size={38} strokeWidth={2.2} /></div>
            <div className="ava c4"><Rocket size={38} strokeWidth={2.2} /></div>
            <div className="ava c5"><Sparkles size={38} strokeWidth={2.2} /></div>
          </div>
